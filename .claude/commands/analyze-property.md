...
**Script Execution:**
```bash
python scripts/calculate_costs.py --address "{ADDRESS}"
```
...
enrichment_data["monthly_cost"] = costs.total
enrichment_data["cost_breakdown"] = {
    "mortgage": costs.mortgage,
    "property_tax": costs.property_tax,
